...
<div class="col-sm-9 col-xs-12 content pt-3 pl-0 mb-0">
    ...
    <h5 class="mb-0 mt-2" >
        ...
        <strong>Halaman | {{ $title_dashboard }}
         ...
         <a href="/datapenanggungjawab/data/create" class="btn btn-info float-right">
...
<div class="card rounded mt-4 p-0">
    <div class="card-body d-flex justify-content-between align-items-center">
        <p class="card-text m-0">
            ...
            <span class="badge badge-secondary"><strong>{{ $datapenanggungjawab->currentPage() }}</strong></span>  
            dari 
