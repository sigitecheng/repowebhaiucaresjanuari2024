...
<div class="col-sm-9 col-xs-12 content pt-3 pl-0 mb-0">
    ...
    <h5 class="mb-0 mt-2" >
        ...
        <strong>Halaman | {{ $title_dashboard }}
         ...
         <a href="/datapengawaslapangan/data/create" class="btn btn-info float-right">
             <span data-feather="file-plus"></span>
             <i class="fas fa-edit"></i> New PIC
           </a>
    </h5>
...
<div class="card rounded mt-4 p-0">
    <div class="card-body d-flex justify-content-between align-items-center">
        <p class="card-text m-0">
            ...
            <span class="badge badge-secondary"><strong>{{ $datapengawaslapangan->currentPage() }}</strong></span>  
            dari 
        ...
        <tbody>
            ...
            <tr>
                ...
                <td class="text-center" style="width: 75px;">
                    ...
                    <a href="/datapengawaslapangan/data/{{ $data->nama }}">
                        <button class="btn btn-primary" data-toggle="modal" ><i class="fa fa-eye"></i></button>
                    </a>
                    <a href="/datapengawaslapangan/data/{{ $data->nama }}/edit">
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                ...
                <form action="/datapengawaslapangan/data/{{ $data->nama_perusahaan }}" method="post" class="d-inline">
                    @csrf
                    @method('delete')
