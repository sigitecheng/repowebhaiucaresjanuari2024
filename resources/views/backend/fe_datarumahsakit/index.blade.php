...
<div class="col-sm-9 col-xs-12 content pt-3 pl-0 mb-0">
    ...
    <h5 class="mb-0 mt-2" >
        ...
        <strong>Halaman | {{ $title_dashboard }}
         ...
         <a href="/backend/rumahsakit/create" class="btn btn-primary float-right">
             <span data-feather="file-plus"></span>
             <i class="fas fa-cogs"></i> New Rumah Sakit
           </a>
    </h5>
...
<div class="card rounded mt-4 p-0">
    <div class="card-body d-flex justify-content-between align-items-center">
        <p class="card-text m-0">
            <i class="fas fa-file mr-2"></i>Halaman <button class="btn btn-sn btn-primary"><strong>{{ $datarumahsakit->currentPage() }}</strong> </button>  dari <button class="btn btn-sn btn-success"><strong class="text-white">{{ $title_dashboard }}</strong></button>
        </p>
    </div>
</div>
    ...
    <table class="table table-striped table-sm mt-4">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td class="text-left">{{ $data->nama_rumahsakit }}</td>  
