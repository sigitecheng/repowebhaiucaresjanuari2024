                        ...
                        <div class="table-responsive product-list">
                            ...
                            <tbody>                            
                                ...
                                <tr>
                                    ...
                                    <td style="width: 100px;"><strong>Layanan Kami </strong></td>
                                    <td style="width: 15px;"class="text-center">:</td>
                                    <td>{{ $beranda->layanan_kami }}</td>
                                </tr>       
            
                                </table>
                                
                                <a href="{{ route('layanankami.edit', ['layanan_kami' => $beranda->layanan_kami]) }}">
                                    <button type="button" class="btn button-edit shadow pull-right mr-2">
                                ...
                                <a href="">
                                    <div class="">
                                        <button class="btn button-custom"><i class="fa fa-eye"></i> View All Data Dashboard Frontend </button>
                                    </div>
                                </a>
                            </div>
                        </div>
