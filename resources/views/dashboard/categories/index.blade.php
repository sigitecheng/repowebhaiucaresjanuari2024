...
<h3 class="mt-2 mb-2">Table Categories</h3>
        ...
        <tbody>
            ...
            <tr>
                ...
                <td class="text-center">
                    ...
                    <a href="/dashboard/categories/{{ $cat->nama_kategori }}" class="badge bg-info"><span data-feather="eye"></span></a>
                    <a href="/dashboard/categories/{{ $cat->nama_kategori }}/edit" class="badge bg-warning"><span data-feather="edit"></span></a>


                    <form action="/dashboard/categories/{{ $cat->nama_kategori }}" method="post" class="d-inline">
                        @method('delete')
                        @csrf
