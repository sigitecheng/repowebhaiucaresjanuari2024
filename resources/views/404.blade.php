...
<html lang="en">
  <head>
    ...
    <!--Custom style.css-->
    <link rel="stylesheet" href="/css/css/quicksand.css">
    ...
    <!--Chartist CSS-->
    <link rel="stylesheet" href="/css/css/chartist.min.css">
    <!--Map-->
    <link rel="stylesheet" href="/css/css/jquery-jvectormap-2.0.2.css">
    <!--Bootstrap Calendar-->
        ...
        <div class="col-md-4 offset-md-4 col-sm-4 offset-sm-4">
            ...
            <div class="buttons mb-5">
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <a href="/dashboard" class="btn button-edit btn-block p-2">Go Home <i class="fa fa-angle-right pull-right"></i></a>
                    </div>
                </div>
            </div>
